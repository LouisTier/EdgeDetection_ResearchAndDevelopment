...
I = double(imread( 'synth_bended.png'));  
...
imwrite( max_grad_s, ['heart/ridges_HK_pc_',num2str(pc),'.png'])
imwrite( f_normalisation(f_crop(lineMap, taille_masque)), 'heart/linemap_HK.png')
imwrite( max_grad_n, ['heart/max_grad_HK.png'])
end
