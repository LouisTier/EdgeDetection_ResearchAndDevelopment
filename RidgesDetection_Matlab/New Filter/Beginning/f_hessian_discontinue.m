...
BGn = C0 * BG_disc; %Gausienne discrete et normalisée
BGx = conv(BGn, dx, 'same'); % Gaussienne dérivée 1ère, discrete et normalisée
BGxx = -conv(BGx, dx, 'same'); % Gaussienne dérivée 2nde, discrete et normalisée
